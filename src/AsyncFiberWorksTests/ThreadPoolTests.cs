...
namespace AsyncFiberWorksTests
{
    ...
    public class ThreadPoolTests
    {
        ...
        public void PoolFiberWithUserThreadPool()
        {
            ...
            {
                pool.Start();
                var fiber1 = new PoolFiberSlim(pool, new DefaultExecutor());
                var fiber2 = new PoolFiberSlim(pool, new DefaultExecutor());
                var fiber3 = new PoolFiberSlim(pool, new DefaultExecutor());
