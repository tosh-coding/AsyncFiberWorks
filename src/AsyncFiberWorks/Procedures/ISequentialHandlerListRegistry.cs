...
namespace AsyncFiberWorks.Procedures
{
    ...
    public interface ISequentialHandlerListRegistry<TMessage>
    {
        ...
        /// Add a handler to the tail.
        /// </summary>
        /// <param name="handler">Message handler. The ProcessedFlagEventArgs.Processed is the processed flag. If this flag is true, subsequent handlers are not called.</param>
        /// <param name="context">The context in which the handler will execute. if null, the default is used.</param>
        /// <returns>Handle for canceling registration.</returns>
        IDisposable Add(Action<IFiberExecutionEventArgs, ProcessedFlagEventArgs<TMessage>> handler, IFiber context = null);
    }
}
